        ...
        <form class="form-horizontal" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                  ...
                  <span class="help-block">The first picture will be set as the main picture for your product. <br><b>Picture should not be larger than 1MB !</b></span>
                </div>
            </div> 
            ...
            <div class="form-group">
                ...
                <div class="col-md-6">
                    <input type="checkbox" name="product[agree]" value="on">I have read and accept <a href="<?php echo SharIt::app()->createUrl('about/policy.php')?>">the terms of use</a>
