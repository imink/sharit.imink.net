    ...
    <div class="col-md-12">
      ...
      <div class="flex-image flexslider">
        <ul class="slides">
          ...
          <li>
            <!-- Image -->
            <a href="<?php echo SharIt::app()->createUrl('product/items.php', array('category' =>53));?>">
            ...
            <div class="flex-caption">
               ...
               <div class="button">
                <a href="<?php echo SharIt::app()->createUrl('product/items.php', array('category' =>53));?>">View Details</a>
               </div>
            </div>
          </li>
          <?php else:?>
          ...
          <li>
            ...
            <div class="flex-caption">
               ...
               <p><?php echo $value[description];?></p>
               <div class="button">
                <a href="<?php echo SharIt::app()->createUrl('product/single-item.php',array('pid'=>$value[product_id]))?>">View Details</a>
               </div>
            </div>
          </li>
          <?php endif; ?>
