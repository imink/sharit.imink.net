        ...
        <div class="form form-small">
            ...
            <input type="hidden" name="payment[oid]" value="<?php echo  $orderInfo[id]?>" >
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-6">
                        <input type="radio" name="payment[paypal]" id="paypal">
                            <img src="http://sharit.ileodo.com/image/payment/paypal.gif" alt="">
                        <input type="radio" name="payment[visa]" id="visa">
                            <img src="http://sharit.ileodo.com/image/payment/visa.gif" alt="">
                        <input type="radio" name="payment[master]" id="master">
                            <img src="http://sharit.ileodo.com/image/payment/mastercard.gif" alt="">
                    </div>
                </div>
