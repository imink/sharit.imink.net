...
$_LAYOUT['right'] =  SharIt::app()->loadView("supervisor/include/ele_productInfo.php",array('user'=>$user,'pForm'=>$pForm,'product'=>$product,'priceHistory'=>$priceHistory,'pErrors'=>$pErrors));
}else{
